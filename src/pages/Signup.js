...
import {
  Container, Button, ButtonGroup, Form, Input, FormText, Alert
} from 'reactstrap';
      ...
      <>
        <div className="vh-100 d-flex">
          <Container className="d-flex align-items-center justify-content-center">
            <Form onSubmit={this.register} className="text-center col-sm-4 col-12">
            <Alert color={isError?'danger':'success'} isOpen={isError || message!==''}>{message}</Alert>
              ...
              <Input onChange={this.onChangeText} type="text" className="mt-5" name="user_name" placeholder="name" />
              <Input onChange={this.onChangeText} type="email" className="mt-3" name="email" placeholder="email" />
              <Input onChange={this.onChangeText} type="password" className="mt-3 mb-4" name="password" placeholder="password" />
